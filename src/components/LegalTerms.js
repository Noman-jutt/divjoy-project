  ...
  return (
    <LongContent>
      ...
      <p>
        ...
        <Link href="https://avodocs.com" target="_blank" rel="noreferrer">
          avodocs.com
        </Link>
        ,&nbsp;
        <Link href="https://getterms.io" target="_blank" rel="noreferrer">
          getterms.io
        </Link>{" "}
        or&nbsp;
        <Link href="https://termly.io" target="_blank" rel="noreferrer">
          termly.io
        </Link>
